...
def process_jormungandr_metrics():
    ...
    metrics2 = jcli_rest(['stake-pool', 'get', '3a192bc7285d7ddfd77c0b854b4008bbf4c5fe53d1ad42770f6ffdf9b3d4c7d6'])
    ...
    try:
       os.system('jcli rest v0 node stats get --host ' + JORMUNGANDR_API + ' > nodestatsx')
    except:
        donothing=0
    ...
    try:
        epochstakecommand = "jcli rest v0 stake get --host " + JORMUNGANDR_API + \
            " | grep -A 1 3a192bc7285d7ddfd77c0b854b4008bbf4c5fe53d1ad42770f6ffdf9b3d4c7d6 | sed -e 's/-//g' | sed -e 's/3a192bc7285d7ddfd77c0b854b4008bbf4c5fe53d1ad42770f6ffdf9b3d4c7d6//g' | sed -r '/^\s*$/d' | awk '{$1=$1;print}' > thisepochstake"
